...
#1
family = ['eva', 'andreas', 'charles']
#2
print(family[-1])
#3
print([len(a) for a in family])
#4
family[-1] = 'charlie'
#5
...
#7
sorted_family = sorted(family, reverse=True)
print(sorted_family)
#8
sorted_family_by_len = sorted(family, key=len)
print(sorted_family_by_len)
...
Write a list comprehension that returns: ['A', 'B', 'C']
'''
upper_letters = [l.upper() for l in word]
...
Write a list comprehension that returns: ['A', 'B', 'C']
'''
first_letter = [a.upper()[0] for a in fruits]
...
family['kids']['bart'] = 'Bart'
family['kids']['lisa'] = 'Lisa'


#Bonus: Do this last step using a list comprehension.
family['kids'] = [l.capitalize() for l in family['kids']]
print(family)
